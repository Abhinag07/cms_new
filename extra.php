...
<body onload="loader()">
                                ...
                                <div class="profile-card shadow d-flex flex-column justify-content-center px-3 py-3 text-center">
                                    ...
                                    <div class="form-popup col-lg-6 col-mb-12 col-mb-12" id="myForm">
                                        <div class="form-container">
                                            ...
                                            <input type="number" placeholder="Enter amount to be donated" style="margin-bottom: -8px;" name="amount" required>

                                            <div class="row justify-content-center">
                                                <button type="submit" id="donatebtn" class="btn tip-button fw-bold col-lg-8 mt-3">Donate</button>
  ...
  -->
    ...
    <script>
        ...
        //var MY_ADDRESS = document.getElementById('metato')
    ...
    const button = document.getElementsByClassName('tip-button');
    if (!wallet.isSignedIn()) {
      button.textContent = 'SignIn with NEAR'
    }
