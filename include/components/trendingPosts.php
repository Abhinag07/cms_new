                                    ...
                                    <div class="card-img p-2">
                                        <a href="<?php echo $row['username']; ?>/<?php echo $row['post_slug']; ?>">
                                            ...
                                            if ($row['featured_image'] == '') {
                                                echo '<img src="assets/images/blogcms.com.png" alt="image" class="img-fluid shadow">';
                                            } else {
                                                echo '<img src="uploads/featuredImages/' . $row['featured_image'] . '" alt="image" class="img-fluid shadow" onError="this.onerror=null;this.src=\'assets/images/blogcms.com.png\';">';
                                            }
                                            ?>
                                        </a>
                                        <?php
