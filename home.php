                ...
                <div class="row py-5">
                    <div class="col-lg-6 col-md-12 col-sm-12 text-center">
                        <div class="card-left mb-5">
                            <h1 class="display-3 fw-bold mb-4">Create Your <br> Own <span class="animated-text-color" id="animated-text-color"></span></h1>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <ul class="nav nav-tabs  flex-column flex-sm-row nav-pills mb-3" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="latest-post-tab" data-bs-toggle="tab" href="#latest-post" role="tab" aria-controls="latest-post" aria-selected="false">Latest Post</a>
                        </li>
                        <?php
                        if (isset($_SESSION['email'])) { ?>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="following-post-tab" data-bs-toggle="tab" href="#following-post" role="tab" aria-controls="following-post" aria-selected="false">Following Post</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="recommended-post-tab" data-bs-toggle="tab" href="#recommended-post" role="tab" aria-controls="recommended-post" aria-selected="true">Recommended Post</a>
                            </li>
                        <?php
                        } else {
                            echo '';
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        if (isset($_SESSION['email'])) { ?>
                            <div class="tab-pane fade" id="following-post" role="tabpanel" aria-labelledby="following-post-tab">
                                <div class="post-following-post">
                                    ...
                                    OR `stories`.`user_uid` = `follow`.`followed_user_uid`) LEFT JOIN `user_login` ON `stories`.`user_uid`=`user_login`.`user_uid`WHERE (`follow`.`following_user_uid`='$user_uid' OR `follow`.`following_user_uid`=NULL) AND(`stories`.`post_status` = 'published' AND `stories`.`unlisted` = 'false') LIMIT 0," . $limitFollowingPost;
                                    $result = mysqli_query($link, $query);
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <?php
                        if (isset($_SESSION['email'])) { ?>
                            <div class="tab-pane fade" id="recommended-post" role="tabpanel" aria-labelledby="recommended-post-tab">
